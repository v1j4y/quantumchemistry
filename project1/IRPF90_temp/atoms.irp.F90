...
subroutine bld_atoms
  use atoms_mod
    implicit none                                                     ! atoms.irp.f:   6
  character*(5) :: irp_here = 'atoms'                                 ! atoms.irp.f:   1
    logical :: is_open                                                ! atoms.irp.f:   7
    inquire(unit=11,opened=is_open)                                   ! atoms.irp.f:   8
    if(.not.is_open)then                                              ! atoms.irp.f:   9
        open(unit=11,status='old',file='geo.inp',form='formatted')    ! atoms.irp.f:  10
    endif                                                             ! atoms.irp.f:  11
